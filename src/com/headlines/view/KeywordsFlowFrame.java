...
public class KeywordsFlowFrame extends FrameLayout implements
	...
	public KeywordsFlowFrame(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public KeywordsFlowFrame(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public KeywordsFlowFrame(Context context) {
		super(context);
		init();
	}
